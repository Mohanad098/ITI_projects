...
/*	MGPIO_voidSetPinMode(KEYPAD_ROW_PORT_ID, KEYPAD_FIRST_ROW_PIN_ID, _MODE_INPUT);
	MGPIO_voidSetPullType(KEYPAD_ROW_PORT_ID, KEYPAD_FIRST_ROW_PIN_ID,_PULL_UP);
	MGPIO_voidSetPinMode(KEYPAD_ROW_PORT_ID, KEYPAD_FIRST_ROW_PIN_ID+1, _MODE_INPUT);
